 ...
 *    ParallelPatterns
 *         ForEachAsync
 *         ExecuteInParallelWithDegreeOfParallelism
 *     WebCrawler
 *         Memoize Async
 *
 *  Module 2
 *     ConsoleTaskEx (ImageProcessing) Map + Compose Tasks
 *
 *  Module 3
 *     AsyncOperations
 *         RequestGate
 *         AsyncOperations  (load + Map + Select Many)
 *     StockAnalyzer
 *         ExecuteInWithDegreeOfParallelism
 *         AsyncEx.Retry
 *         Otherwise
 *
 * LinqPAD Quiz
